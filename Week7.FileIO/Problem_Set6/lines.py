...
# Of course, just because a program (or even function)
# has more lines of code than another doesn’t necessarily mean it’s more complex.
#
...
def main():
    check_arguments()
    print(quantify_lines(sys.argv[1]))
...
def quantify_lines(python_file):
    x = 0
